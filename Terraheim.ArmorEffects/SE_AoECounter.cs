...
internal class SE_AoECounter : StatusEffect
{
	...
	public void Awake()
	{
		m_name = "Wyrdarrow";
		base.name = "Wyrdarrow";
		m_tooltip = "Hitting an enemy " + m_activationCount + " times charges you. The next bowshot or special attack with daggers and spears will deal " + m_damageBonus * 100f + "% of damage dealt as spirit/frost damage in a " + m_aoeSize + "m radius.";
	}
	...
	{
		m_damageBonus = bonus;
		m_tooltip = "Hitting an enemy " + m_activationCount + " times charges you. The next special attack with daggers and spear or fully charged attack with bows will deal " + m_damageBonus * 100f + "% of damage dealt as spirit/frost damage in a " + m_aoeSize + "m radius.";
	}
