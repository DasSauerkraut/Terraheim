...
internal class Data
{
	...
	public static EffectList.EffectData VFXDamageAtFullHp { get; set; }

	public static EffectList.EffectData VFXAoECharged { get; set; }

	public static EffectList.EffectData VFXMarkedForDeath { get; set; }
