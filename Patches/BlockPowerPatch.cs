...
namespace Terraheim.Patches
{
    ...
    public static class BlockPowerPatch
    {
        ...
        {
            if (__instance.GetSEMan().HaveStatusEffect("Block Power Bonus"))
            {
                ...
                __instance.GetCurrentBlocker().m_shared.m_blockPower += baseWeapon.m_itemData.m_shared.m_blockPower * effect.GetBlockPower();
